	...
	<body>
		...
		<div id="show-lab" class="content scaffold-show" role="main">
			...
			<ol class="property-list lab">
				...
				<g:if test="${labInstance?.password}">
				<li class="fieldcontain">
					<span id="password-label" class="property-label"><g:message code="lab.password.label" default="Password" /></span>
					
						<span class="property-value" aria-labelledby="password-label"><g:fieldValue bean="${labInstance}" field="password"/></span>
				...
				<g:if test="${labInstance?.accountExpired}">
				<li class="fieldcontain">
					<span id="accountExpired-label" class="property-label"><g:message code="lab.accountExpired.label" default="Account Expired" /></span>
					
						<span class="property-value" aria-labelledby="accountExpired-label"><g:formatBoolean boolean="${labInstance?.accountExpired}" /></span>
				...
				<g:if test="${labInstance?.passwordExpired}">
				<li class="fieldcontain">
					<span id="passwordExpired-label" class="property-label"><g:message code="lab.passwordExpired.label" default="Password Expired" /></span>
					
						<span class="property-value" aria-labelledby="passwordExpired-label"><g:formatBoolean boolean="${labInstance?.passwordExpired}" /></span>
